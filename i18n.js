 <!-- SCRIPT HỖ TRỢ ĐỔI NGÔN NGỮ & LƯU TRỮ LOCALSTORAGE -->
    ...
    const translations = {
      vi: {
        ...
        dropzoneFormats: "Hỗ trợ: PDF (.pdf), Word (.docx), Văn bản (.txt, .md)",
      ...
      en: {
        ...
        tabText: "Text",
        tabUrl: "Web Link",
        tabFile: "📁 Upload File (PDF/Word/TXT)",
        ...
        dropzoneFormats: "Supports: PDF (.pdf), Word (.docx), Text (.txt, .md)",
